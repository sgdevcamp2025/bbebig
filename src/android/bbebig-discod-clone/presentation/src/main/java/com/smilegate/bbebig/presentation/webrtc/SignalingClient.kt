...
package com.smilegate.bbebig.presentation.webrtc

import android.util.Log
import com.smilegate.devcamp.presentation.BuildConfig
...
class SignalingClient {
    ...
    private val request = Request
        .Builder()
        .url("ws://43.203.136.82:9070/ws-stream/pub/stream/group")
        .build()
    ...
    private inner class SignalingWebSocketListener : WebSocketListener() {
        override fun onOpen(webSocket: WebSocket, response: Response) {
            ...
            Log.d("SignalingClient", "onOpen: $response")
        }
        override fun onMessage(webSocket: WebSocket, text: String) {
            Log.d("SignalingClient", "onMessage: $text")
            when {
                ...
                text.startsWith(SignalingCommand.CANDIDATE.toString(), true) ->
                    handleSignalingCommand(SignalingCommand.CANDIDATE, text)
            }
        }
    }
